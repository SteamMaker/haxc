...
namespace HAXCSolar.Controls
{
  public sealed partial class CircularProgressBar : UserControl
  {
    ...
    public static readonly DependencyProperty SegmentColorProperty =
        DependencyProperty.Register("SegmentColor", typeof(Brush), typeof(CircularProgressBar), new PropertyMetadata(new SolidColorBrush(Colors.Red), new PropertyChangedCallback(OnPropertyChanged)));
    ...
    public static readonly DependencyProperty IsClockWiseProperty =
        DependencyProperty.Register("IsClockwise", typeof(bool), typeof(CircularProgressBar), new PropertyMetadata(true, new PropertyChangedCallback(OnPropertyChanged)));
    ...
    public void RenderArc()
    {
      ...
      //pathRoot.Stroke = SegmentColor;

      bool largeArc = IsClockwise ? Angle > 180.0 : Angle < 180.0;
      ...
      if (startPoint.X == Math.Round(endPoint.X) && startPoint.Y == Math.Round(endPoint.Y))
        endPoint.X += IsClockwise ? -0.01 : 0.01;
